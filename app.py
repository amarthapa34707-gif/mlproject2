...
from src.mlproject2.components.data_transformation import DataTransformationConfig,DataTransformation
from src.mlproject2.components.model_trainer import ModelTrainerConfig,ModelTrainer
